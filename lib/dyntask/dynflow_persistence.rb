  ...
  class DynflowPersistence < Dynflow::PersistenceAdapters::Sequel
    ...
    def save_execution_plan(execution_plan_id, value)
      super.tap do
        begin
          ...
          Dyntask.world.logger.error('Error on on_execution_plan_save event')
          Dyntask.world.logger.error(e.message)
          Dyntask.world.logger.error(e.backtrace.join("\n"))
        end
      end
    end
    ...
    def on_execution_plan_save(execution_plan_id, data)
      ...
      if data[:state] == :pending
        ...
        task = ::Dyntask::Task::DynflowTask.find_by_external_id(execution_plan_id)
