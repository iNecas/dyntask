module Dyntask
  class Dynflow::Configuration
    ...
    # set true if the dynflow web console should be mounted
    attr_accessor :web_console
    alias_method :web_console?, :web_console
    ...
    # it can't be remote
    def remote?
      !Dyntask.dynflow.executor? && @remote
    end
    ...
    def default_persistence_adapter
      Dyntask::Dynflow::Persistence.new(default_sequel_adapter_options)
    end
